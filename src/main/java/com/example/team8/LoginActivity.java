...
import com.example.team8.database.UserDatabase;
import com.example.team8.database.model.User;
import com.example.team8.util.Constant;
import com.example.team8.util.Utilidades;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        switch (v.getId()){
            case R.id.btn_login:
                ...
                if (usuario.equals("admin@admin.com") && contrasena.equals("admin")) {
                    ...
                    //Toast.makeText(this, "ERROR INICIANDO SESIÃ“N", Toast.LENGTH_SHORT).show();
                }
    ...
    public void toLogin(String usuario, String contrasena, String nombre, String imagen){
        Toast.makeText(this, "SE HA INICIADO SESIO“N", Toast.LENGTH_SHORT).show();
    ...
    private static class GetUserLoginTask extends AsyncTask<Void, Void, User> {
        ...
        protected void onPostExecute(User user) {
            if (user != null) {
                ...
                Log.e("LOGINTASK", "INICIO DE SESION NO VALIDA");
            }
